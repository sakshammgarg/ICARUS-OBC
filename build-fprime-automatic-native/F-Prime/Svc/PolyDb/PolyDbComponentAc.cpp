...
namespace Svc {
  ...
  FwIndexType PolyDbComponentBase ::
    getNum_getValue_InputPorts() const
  {
    return static_cast<FwIndexType>(FW_NUM_ARRAY_ELEMENTS(this->m_getValue_InputPort));
  }

  FwIndexType PolyDbComponentBase ::
    getNum_setValue_InputPorts() const
  {
    return static_cast<FwIndexType>(FW_NUM_ARRAY_ELEMENTS(this->m_setValue_InputPort));
  }

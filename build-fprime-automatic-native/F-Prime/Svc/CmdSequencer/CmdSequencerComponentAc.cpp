...
namespace Svc {
  ...
  void CmdSequencerComponentBase ::
    log_ACTIVITY_LO_CS_SequenceLoaded(const Fw::StringBase& fileName)
  {
    // Get the time
    Fw::Time _logTime;
  ...
  void CmdSequencerComponentBase ::
    log_ACTIVITY_HI_CS_SequenceCanceled(const Fw::StringBase& fileName)
  {
    // Get the time
    Fw::Time _logTime;
    if (this->m_timeCaller_OutputPort[0].isConnected()) {
  ...
  void CmdSequencerComponentBase ::
    log_WARNING_HI_CS_FileReadError(const Fw::StringBase& fileName)
  {
    // Get the time
    Fw::Time _logTime;
    if (this->m_timeCaller_OutputPort[0].isConnected()) {
  ...
  void CmdSequencerComponentBase ::
    log_WARNING_HI_CS_FileNotFound(const Fw::StringBase& fileName)
  {
    // Get the time
    Fw::Time _logTime;
    if (this->m_timeCaller_OutputPort[0].isConnected()) {
  ...
  void CmdSequencerComponentBase ::
    log_ACTIVITY_HI_CS_SequenceComplete(const Fw::StringBase& fileName)
  {
    // Get the time
    Fw::Time _logTime;
    if (this->m_timeCaller_OutputPort[0].isConnected()) {
  ...
  void CmdSequencerComponentBase ::
    log_ACTIVITY_HI_CS_PortSequenceStarted(const Fw::StringBase& filename)
  {
    // Get the time
    Fw::Time _logTime;
    if (this->m_timeCaller_OutputPort[0].isConnected()) {
  ...
  void CmdSequencerComponentBase ::
    log_ACTIVITY_HI_CS_SequenceValid(const Fw::StringBase& filename)
  {
    // Get the time
    Fw::Time _logTime;
    if (this->m_timeCaller_OutputPort[0].isConnected()) {
  ...
  void CmdSequencerComponentBase ::
    log_ACTIVITY_HI_CS_CmdStarted(const Fw::StringBase& filename)
  {
    // Get the time
    Fw::Time _logTime;
    if (this->m_timeCaller_OutputPort[0].isConnected()) {

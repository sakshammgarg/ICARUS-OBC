...
namespace Svc {
    ...
    init(FwEnumStoreType instance)
  {
    ...
    for (
      FwIndexType port = 0;
      port < static_cast<FwIndexType>(this->getNum_framedAllocate_OutputPorts());
      port++
    ) {
    ...
    for (
      FwIndexType port = 0;
      port < static_cast<FwIndexType>(this->getNum_framedOut_OutputPorts());
      port++
    ) {
  ...
  FwIndexType FramerComponentBase ::
  ...
  {
    return static_cast<FwIndexType>(FW_NUM_ARRAY_ELEMENTS(this->m_framedAllocate_OutputPort));
  }

  FwIndexType FramerComponentBase ::
    getNum_framedOut_OutputPorts() const
  {
    return static_cast<FwIndexType>(FW_NUM_ARRAY_ELEMENTS(this->m_framedOut_OutputPort));
  }
  ...
  bool FramerComponentBase ::
    isConnected_framedAllocate_OutputPort(FwIndexType portNum)
  {
    FW_ASSERT(
      portNum < this->getNum_framedAllocate_OutputPorts(),
      static_cast<FwAssertArgType>(portNum)
  ...
  bool FramerComponentBase ::
    isConnected_framedOut_OutputPort(FwIndexType portNum)
  {
    FW_ASSERT(
      portNum < this->getNum_framedOut_OutputPorts(),
      static_cast<FwAssertArgType>(portNum)

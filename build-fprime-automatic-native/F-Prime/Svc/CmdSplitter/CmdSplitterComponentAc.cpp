...
namespace Svc {
  ...
  FwIndexType CmdSplitterComponentBase ::
    getNum_CmdBuff_InputPorts() const
  {
    return static_cast<FwIndexType>(FW_NUM_ARRAY_ELEMENTS(this->m_CmdBuff_InputPort));
  }

  FwIndexType CmdSplitterComponentBase ::
    getNum_seqCmdStatus_InputPorts() const
  {
    return static_cast<FwIndexType>(FW_NUM_ARRAY_ELEMENTS(this->m_seqCmdStatus_InputPort));
  }
  ...
  {
    return static_cast<FwIndexType>(FW_NUM_ARRAY_ELEMENTS(this->m_LocalCmd_OutputPort));
  }

  FwIndexType CmdSplitterComponentBase ::
    getNum_RemoteCmd_OutputPorts() const
  {
    return static_cast<FwIndexType>(FW_NUM_ARRAY_ELEMENTS(this->m_RemoteCmd_OutputPort));
  }

  FwIndexType CmdSplitterComponentBase ::
    getNum_forwardSeqCmdStatus_OutputPorts() const
  {
    return static_cast<FwIndexType>(FW_NUM_ARRAY_ELEMENTS(this->m_forwardSeqCmdStatus_OutputPort));
  }

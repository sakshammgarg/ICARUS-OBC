...
namespace Svc {
    ...
    init(FwEnumStoreType instance)
  {
    ...
    for (
      FwIndexType port = 0;
      port < static_cast<FwIndexType>(this->getNum_comDataIn_InputPorts());
      port++
    ) {
      ...
      this->m_comDataIn_InputPort[port].setObjName(portName.toChar());
#endif
    }
    ...
    for (
      FwIndexType port = 0;
      port < static_cast<FwIndexType>(this->getNum_drvDataIn_InputPorts());
      port++
    ) {
      ...
      this->m_drvDataIn_InputPort[port].setObjName(portName.toChar());
#endif
    }
    ...
    for (
      FwIndexType port = 0;
      port < static_cast<FwIndexType>(this->getNum_comDataOut_OutputPorts());
      port++
    ) {
      ...
      this->m_comDataOut_OutputPort[port].setObjName(portName.toChar());
#endif
    }
    ...
    for (
      FwIndexType port = 0;
      port < static_cast<FwIndexType>(this->getNum_comStatus_OutputPorts());
      port++
    ) {
      ...
      this->m_comStatus_OutputPort[port].setObjName(portName.toChar());
#endif
    }
    ...
    for (
      FwIndexType port = 0;
      port < static_cast<FwIndexType>(this->getNum_drvDataOut_OutputPorts());
      port++
    ) {
      ...
      this->m_drvDataOut_OutputPort[port].setObjName(portName.toChar());
#endif
    }
  }
  ...
  Drv::InputByteStreamSendPort* ComStubComponentBase ::
    get_comDataIn_InputPort(FwIndexType portNum)
  {
    FW_ASSERT(
  ...
  Drv::InputByteStreamRecvPort* ComStubComponentBase ::
    get_drvDataIn_InputPort(FwIndexType portNum)
  {
    FW_ASSERT(
  ...
  {
    return static_cast<FwIndexType>(FW_NUM_ARRAY_ELEMENTS(this->m_comDataIn_InputPort));
  }
  ...
  {
    return static_cast<FwIndexType>(FW_NUM_ARRAY_ELEMENTS(this->m_drvDataIn_InputPort));
  }
  ...
  {
    return static_cast<FwIndexType>(FW_NUM_ARRAY_ELEMENTS(this->m_comDataOut_OutputPort));
  }

  FwIndexType ComStubComponentBase ::
    getNum_comStatus_OutputPorts() const
  {
    return static_cast<FwIndexType>(FW_NUM_ARRAY_ELEMENTS(this->m_comStatus_OutputPort));
  }

  FwIndexType ComStubComponentBase ::
    getNum_drvDataOut_OutputPorts() const
  {
    return static_cast<FwIndexType>(FW_NUM_ARRAY_ELEMENTS(this->m_drvDataOut_OutputPort));
  }
  ...
  bool ComStubComponentBase ::
    isConnected_comDataOut_OutputPort(FwIndexType portNum)
  {
    FW_ASSERT(
      portNum < this->getNum_comDataOut_OutputPorts(),
      static_cast<FwAssertArgType>(portNum)
  ...
  bool ComStubComponentBase ::
    isConnected_comStatus_OutputPort(FwIndexType portNum)
  {
    FW_ASSERT(
      portNum < this->getNum_comStatus_OutputPorts(),
      static_cast<FwAssertArgType>(portNum)
  ...
  bool ComStubComponentBase ::
    isConnected_drvDataOut_OutputPort(FwIndexType portNum)
  {
    FW_ASSERT(
      portNum < this->getNum_drvDataOut_OutputPorts(),
      static_cast<FwAssertArgType>(portNum)

...
namespace Svc {
  ...
  void VersionComponentBase ::
    log_ACTIVITY_LO_FrameworkVersion(const Fw::StringBase& version)
  {
    // Get the time
    Fw::Time _logTime;
  ...
  void VersionComponentBase ::
    log_ACTIVITY_LO_ProjectVersion(const Fw::StringBase& version)
  {
    // Get the time
    Fw::Time _logTime;
    if (this->m_timeCaller_OutputPort[0].isConnected()) {
  ...
  void VersionComponentBase ::
    log_ACTIVITY_LO_LibraryVersions(const Fw::StringBase& version)
  {
    // Get the time
    Fw::Time _logTime;
    if (this->m_timeCaller_OutputPort[0].isConnected()) {

...
namespace Svc {
  ...
  void HealthComponentBase ::
    log_WARNING_HI_HLTH_PING_WARN(const Fw::StringBase& entry)
  {
    // Get the time
    Fw::Time _logTime;
  ...
  void HealthComponentBase ::
    log_FATAL_HLTH_PING_LATE(const Fw::StringBase& entry)
  {
    // Get the time
    Fw::Time _logTime;
    if (this->m_Time_OutputPort[0].isConnected()) {
  ...
  void HealthComponentBase ::
    log_WARNING_LO_HLTH_CHECK_LOOKUP_ERROR(const Fw::StringBase& entry)
  {
    // Get the time
    Fw::Time _logTime;
    if (this->m_Time_OutputPort[0].isConnected()) {
